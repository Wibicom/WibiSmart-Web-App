...
@login_required()
def scan(request):
    r = requests.get("http://192.168.1.200:8010/gap/nodes")
...
def disconnect(request, id):
    device_to_connect = Device.objects.get(id = id)
    address = device_to_connect.deviceNb
    requests.get('http://192.168.1.200:8010/gatt/nodes/' + address +'/disconnect')  # request connection to that device
    return redirect ('devicemanager')
    ...
    if request.method == 'POST': #if the user changes the settings
        ...
        if (str(requestdict['formdata']) == "accelerometer"):
            if 'checkbox-accelerometer' in requestdict:
                ...
                url_checkbox = 'http://192.168.1.200:8010/gatt/nodes/' + address + '/characteristics/aa82/value/1'
                url_slider = 'http://192.168.1.200:8010/gatt/nodes/' + address + '/characteristics/aa83/value/' + slider_value
                print "url checkbox"
                print url_checkbox
                ...
                url_checkbox = 'http://192.168.1.200:8010/gatt/nodes/' + address + '/characteristics/aa82/value/0'
                r = requests.put(url_checkbox)
            ...
            if 'checkbox-weather' in requestdict:
                ...
                slider_value = str(slider_value)
                url_checkbox = 'http://192.168.1.200:8010/gatt/nodes/' + address + '/characteristics/aa42/value/1'
                url_slider = 'http://192.168.1.200:8010/gatt/nodes/' + address + '/characteristics/aa44/value/' + slider_value
                r = requests.put(url_checkbox)
                b = requests.put(url_slider)
            else:
                url_checkbox = 'http://192.168.1.200:8010/gatt/nodes/' + address + '/characteristics/aa42/value/0'
                r = requests.put(url_checkbox)
            ...
            if 'checkbox-light' in requestdict :
                ...
                slider_value = str(slider_value)
                url_checkbox = 'http://192.168.1.200:8010/gatt/nodes/' + address + '/characteristics/aa22/value/1'
                print "-----------------LIGHT URL-------------------"
                print url_checkbox
                url_slider = 'http://192.168.1.200:8010/gatt/nodes/' + address + '/characteristics/aa23/value/' + slider_value
                r = requests.put(url_checkbox)
                b = requests.put(url_slider)
            else:
                url_checkbox = 'http://192.168.1.200:8010/gatt/nodes/' + address + '/characteristics/aa22/value/0'
                r = requests.put(url_checkbox)
        else:
            print "shit happened"


    response = requests.get('http://192.168.1.200:8010/gatt/nodes/' + address + '/settings')
