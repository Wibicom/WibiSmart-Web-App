...
urlpatterns = [
    ...
    url(r'^devicemanager/(?P<id>\d+)/disconnect/$', 'devicemanager.views.disconnect', name='disconnect'),
    url(r'^devicemanager/(?P<id>\d+)/connect/$', 'devicemanager.views.connect', name='connect')
